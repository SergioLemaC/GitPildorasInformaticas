...
class LaminaBotones extends JPanel implements ActionListener {
    ...
    public LaminaBotones() {
         ...
         * 
         *  botonNegro.addActionListener(negro); // Al hacer clic
    ...
    // Obligatoriamente debemos construir la función actionPerformed() ya que la
    // clase
    // implementa la interfaz ActionListener
    public void actionPerformed(ActionEvent e) { // Después de que tenga lugar ese evento, se crearán objetos de tipo
                                                 // event y se almacenarán en la (e)
    ...
    /*CLASE INTERNA - OTRA FORMA DE PROGRAMARLO
